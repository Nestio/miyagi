    ...
    <div className="introduction-page">
      <div className="max-w-[760px] mx-auto px-8">
        <div className="docs-intro">
          <DocsH1>Funnel API Terms of Use</DocsH1>
          <DocsP variant="lead">
        ...
        <DocsSection>
          ...
          <DocsP>
            Your right to use the Funnel API terminates automatically if:
          </DocsP>
          ...
          <DocsP>
            Sections 4, 5 and 7 through 9 shall survive termination of this Agreement.
          </DocsP>
        </DocsSection>
        ...
        <Callout type="info" title="Need Help?">
          ...
          <a 
            href="mailto:support@funnelleasing.com" 
            className="docs-link"
          >
        ...
        <DocsSection>
          ...
          <DocsP variant="body">
            ...
            <a 
              href="https://developer.funnelleasing.com" 
              className="docs-link"
              target="_blank"
        ...
        <DocsSection>
          ...
          <DocsP>
            This includes any content created or derived therefrom.
          </DocsP>
          ...
          <DocsP>
            Any use of Licensee's Marks shall be in accordance with your reasonable trademark usage policies if such policies are communicated in writing to Funnel.
          </DocsP>
        ...
        <DocsSection>
          ...
          <DocsUl>
            <li>
              If to Funnel: <a 
                href="mailto:apisupport@funnelleasing.com" 
                className="docs-link"
              >apisupport@funnelleasing.com</a>
            </li>
